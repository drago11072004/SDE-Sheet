import java.util.*;        //this is for printing the shortest path between the source and n ;
class Pair{               //problem link-> https://practice.geeksforgeeks.org/problems/shortest-path-in-weighted-undirected-graph/1
    int first;
    int second;
